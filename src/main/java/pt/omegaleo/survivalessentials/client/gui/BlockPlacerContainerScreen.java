...
public class BlockPlacerContainerScreen extends AbstractContainerScreen<BlockPlacerContainer> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/gui/container/generic_54.png");

    private final Inventory playerInventory;
    private final int inventoryRows;

    public BlockPlacerContainerScreen(BlockPlacerContainer screenContainer, Inventory inv, Component titleIn) {
