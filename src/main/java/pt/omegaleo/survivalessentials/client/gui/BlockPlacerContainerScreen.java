...
public class BlockPlacerContainerScreen extends ContainerScreen<BlockPlacerContainer> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/gui/container/generic_54.png");

    private final PlayerInventory playerInventory;
    private final int inventoryRows;

    public BlockPlacerContainerScreen(BlockPlacerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
