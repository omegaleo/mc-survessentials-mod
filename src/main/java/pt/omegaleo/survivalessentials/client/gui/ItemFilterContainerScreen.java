...
public class ItemFilterContainerScreen extends ContainerScreen<ItemFilterContainer> 
{
    ...
    public ItemFilterContainerScreen(ItemFilterContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        this.font.drawString(matrixStack, playerInventory.getDisplayName().getString(), 8, 40, 4210752);
    }
